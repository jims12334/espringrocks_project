        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 w-full">
                ...
                <DashboardTile
                    ...
                    stat={`₱${Number(dashboardStats.revenue_trend.slice(-1)[0]?.revenue || 0).toLocaleString("en-PH")}`}
                    subtitle={`As of ${getFullDate(new Date())}`}
                />
            </div>
            ...
            <div>
                <Container>
                    <DashboardHeader title="Revenue Growth (2026)" subtitle="Monthly trend analysis" />
                    <LineChart
                        height={300}
                        xAxis={[
                            {
                                data: dashboardStats.revenue_trend.map((r) => r.month),
                                scaleType: "point",
                                tickLabelStyle: {
                                    fontFamily: "Inter",
                                    fontSize: 10,
                        ...
                        series={[
                            {
                                data: dashboardStats.revenue_trend.map((r) => r.revenue),
                                color: "#f59e0b",
                                valueFormatter: (value) => `₱${value.toLocaleString("en-PH")}`,
                            },
                        ]}
